...
class Generator(nn.Module):
    ...
    def __init__(self, input_dims, output_dims):
        ...
        self.fc1 = nn.Sequential(nn.Linear(1024, output_dims), nn.Tanh())
...
class Discriminator(nn.Module):
    ...
    def __init__(self, input_dims, output_dims=1):
        ...
        ###  TODO: Change the architecture and value as CW2 Guidance required
#         self.fc0 = nn.Sequential(nn.Linear(input_dims, 1024),nn.LeakyReLU(0.2),nn.Dropout(0.3),
#             nn.Linear(1024, 512),nn.LeakyReLU(0.2),nn.Dropout(0.3),
#             nn.Linear(512, 256),nn.LeakyReLU(0.2),nn.Dropout(0.3)
            
#         )
        self.fc0 = nn.Sequential(nn.Linear(input_dims, 1024),nn.LeakyReLU(0.2),
...
def show_result(G_net, z_, num_epoch, show=False, save=False, path='result.png'):
    ...
    fig.suptitle('Epoch number: {}'.format(num_epoch))
...
if __name__ == '__main__':
    ...
    image_save_dir = './MNIST_GAN_results/results_wdr'
